...
__nccwpck_require__.d(__webpack_exports__, {
  Ow: () => (/* reexport */ CHANNEL_ID_REGEX),
  Ku: () => (/* reexport */ CHANNEL_REGEX),
  bw: () => (/* reexport */ MARKER_REGEX),
  Gf: () => (/* reexport */ MAX_SECTION_TEXT_LENGTH),
  l1: () => (/* reexport */ REVIEW_VERDICT),
  H5: () => (/* reexport */ USERS_ID_REGEX),
  V$: () => (/* reexport */ USERS_REGEX),
  IS: () => (/* reexport */ buildRootMessage),
  B6: () => (/* reexport */ buildThreadReply),
  L8: () => (/* reexport */ classify),
  Rl: () => (/* reexport */ commentGrammar),
  WQ: () => (/* reexport */ inject),
  f: () => (/* reexport */ isBotActor),
  UY: () => (/* reexport */ loadChannelConfig),
  ni: () => (/* reexport */ loadUsersMap),
  qg: () => (/* reexport */ parse),
  hd: () => (/* reexport */ resolve),
  WZ: () => (/* reexport */ resolveAll),
  lK: () => (/* reexport */ serialize),
  bB: () => (/* reexport */ strip)
});
...
const USERS_ID_REGEX = /^U[A-Z0-9]+$/;
const CHANNEL_ID_REGEX = /^[CG][A-Z0-9]+$/;

;// CONCATENATED MODULE: ./src/lib/marker.ts
 ...
 */
const MARKER_REGEX = /<!--\s*pr-bot:thread_ts=(\S+?)\s*-->/;
/**
 ...
 */
function resolve(login, usersMap, opts = {}) {
    const slackId = usersMap.users[login];
    if (slackId !== undefined) {
        return { kind: 'mapped', text: `<@${slackId}>`, login };
    }
    const warn = opts.warn ?? noopWarn;
    warn(`mentions.resolve: no Slack ID mapping for github login "${login}" — falling back to plain @${login}`);
 ...
 */
function resolveAll(logins, usersMap, opts = {}) {
    return logins.map((l) => resolve(l, usersMap, opts));
}

;// CONCATENATED MODULE: ./src/lib/bot-filter.ts
...
function isBotActor(actor) {
    ...
    if (actor.type === 'Bot')
        return true;
    if (actor.login !== undefined && actor.login.endsWith('[bot]'))
        return true;
    return false;
}
 ...
 */
function buildThreadReply(args) {
    return {
...
const USERS_REGEX = USERS_ID_REGEX;
const CHANNEL_REGEX = CHANNEL_ID_REGEX;
/**
...
function loadUsersMap(yamlText) {
    const parsed = (0,dist/* parse */.qg)(yamlText);
...
var __webpack_exports__CHANNEL_ID_REGEX = __webpack_exports__.Ow;
var __webpack_exports__CHANNEL_REGEX = __webpack_exports__.Ku;
var __webpack_exports__MARKER_REGEX = __webpack_exports__.bw;
var __webpack_exports__MAX_SECTION_TEXT_LENGTH = __webpack_exports__.Gf;
var __webpack_exports__REVIEW_VERDICT = __webpack_exports__.l1;
var __webpack_exports__USERS_ID_REGEX = __webpack_exports__.H5;
var __webpack_exports__USERS_REGEX = __webpack_exports__.V$;
var __webpack_exports__buildRootMessage = __webpack_exports__.IS;
var __webpack_exports__buildThreadReply = __webpack_exports__.B6;
var __webpack_exports__classify = __webpack_exports__.L8;
var __webpack_exports__commentGrammar = __webpack_exports__.Rl;
var __webpack_exports__inject = __webpack_exports__.WQ;
var __webpack_exports__isBotActor = __webpack_exports__.f;
var __webpack_exports__loadChannelConfig = __webpack_exports__.UY;
var __webpack_exports__loadUsersMap = __webpack_exports__.ni;
var __webpack_exports__parse = __webpack_exports__.qg;
var __webpack_exports__resolve = __webpack_exports__.hd;
var __webpack_exports__resolveAll = __webpack_exports__.WZ;
var __webpack_exports__serialize = __webpack_exports__.lK;
var __webpack_exports__strip = __webpack_exports__.bB;
export { __webpack_exports__CHANNEL_ID_REGEX as CHANNEL_ID_REGEX, __webpack_exports__CHANNEL_REGEX as CHANNEL_REGEX, __webpack_exports__MARKER_REGEX as MARKER_REGEX, __webpack_exports__MAX_SECTION_TEXT_LENGTH as MAX_SECTION_TEXT_LENGTH, __webpack_exports__REVIEW_VERDICT as REVIEW_VERDICT, __webpack_exports__USERS_ID_REGEX as USERS_ID_REGEX, __webpack_exports__USERS_REGEX as USERS_REGEX, __webpack_exports__buildRootMessage as buildRootMessage, __webpack_exports__buildThreadReply as buildThreadReply, __webpack_exports__classify as classify, __webpack_exports__commentGrammar as commentGrammar, __webpack_exports__inject as inject, __webpack_exports__isBotActor as isBotActor, __webpack_exports__loadChannelConfig as loadChannelConfig, __webpack_exports__loadUsersMap as loadUsersMap, __webpack_exports__parse as parse, __webpack_exports__resolve as resolve, __webpack_exports__resolveAll as resolveAll, __webpack_exports__serialize as serialize, __webpack_exports__strip as strip };
